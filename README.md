...
### 🪶 **README.md — Portfólio Pessoal de Isabelle Mendes**
...
O layout foi planejado para ser **adaptável a diferentes dispositivos**, utilizando técnicas de:
- **Flexbox**  
- **Media Queries**  
...
🔗 **[Clique aqui para acessar o site publicado](https://izzydrafts.github.io/)**  
*(substitua esse link pelo seu link exato do GitHub Pages)*

O código-fonte completo está disponível no repositório:

📁 **[Acessar repositório no GitHub](https://github.com/izzydrafts/portfolio)**  
